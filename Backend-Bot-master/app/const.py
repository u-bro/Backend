HTTP_ERROR_MESSAGES = {
    ...
    404: ("NOT_FOUND",),
    409: ("CONFLICT", "DRIVER_PENDING_REQUEST_LIMIT", "RIDE_REQUEST_ALREADY_EXISTS", "DRIVER_ALREADY_ASSIGNED", "RIDE_ALREADY_ASSIGNED", "RIDE_REQUEST_NOT_PENDING", "RIDE_STATUS_CONFLICT", "RIDE_COMMISSION_ALREADY_PAID"),
