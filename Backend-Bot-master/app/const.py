HTTP_ERROR_MESSAGES = {
    500: ("UNKNOWN",),
    400: ("VALIDATION_ERROR", "VALIDATION_ERROR_MAIL", "VALIDATION_ERROR_PHONE", "VALIDATION_ERROR_DRIVER_DOCUMENT_TYPE"),
    401: ("UNAUTHORIZED", "CODE_EXPIRED", "CODE_INVALID"),
    403: ("FORBIDDEN", "DRIVER_PROFILE_NOT_APPROVED", "FORBIDDEN_DRIVER_SEARCH"),
    404: ("NOT_FOUND",),
    409: ("CONFLICT", "DRIVER_PENDING_REQUEST_LIMIT", "RIDE_REQUEST_ALREADY_EXISTS", "DRIVER_ALREADY_ASSIGNED", "RIDE_ALREADY_ASSIGNED", "RIDE_REQUEST_NOT_PENDING", "RIDE_STATUS_CONFLICT", "RIDE_COMMISSION_ALREADY_PAID", "DRIVER_HAS_ACTIVE_RIDE_PROFILE_UPDATE_FORBIDDEN", "APPROVED_DRIVER_PROFILE_ADMIN_UPDATE_FORBIDDEN", "DRIVER_PROFILE_CHANGED_DURING_MODERATION"),
