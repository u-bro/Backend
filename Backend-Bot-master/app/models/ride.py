...
class Ride(Base):
    ...
    pickup_lat: Mapped[float | None] = mapped_column(DECIMAL(12, 8), nullable=True)
    pickup_lng: Mapped[float | None] = mapped_column(DECIMAL(12, 8), nullable=True)
    ...
    canceled_at = mapped_column(TIMESTAMP, nullable=True)
