...
class Ride(models.Model):
    ...
    pickup_lat = models.DecimalField(max_digits=12, decimal_places=8, null=True, blank=True)
    pickup_lng = models.DecimalField(max_digits=12, decimal_places=8, null=True, blank=True)
    ...
    ride_metadata = models.JSONField(null=True, blank=True)
