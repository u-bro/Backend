...
class FastAPIClient:
    ...
    def moderate_driver(self, driver_id: int, status: str, moderation_info_ids: list[int], admin_user_id: int, expected_updated_at, classes_allowed: list[str] | None = None) -> bool:
        try:
